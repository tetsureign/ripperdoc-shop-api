...
namespace RipperdocShop.Api.Migrations
{
    ...
    [Migration("20250415091018_InitDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RipperdocShop.Models.Identity.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("RipperdocShop.Models.Identity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RipperdocShop.Models.Entities.CartItem", b =>
                {
                    ...
                    b.HasOne("RipperdocShop.Models.Identity.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
