...
public class ListAdminProductRatingsByProductQuery(ApplicationDbContext context)
{
    public async Task<AdminProductRatingResponse> ExecuteAsync(Guid productId, bool includeDeleted, int page,
        int pageSize)
    {
